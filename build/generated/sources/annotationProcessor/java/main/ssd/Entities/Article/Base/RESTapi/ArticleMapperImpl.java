...
public class ArticleMapperImpl implements ArticleMapper {
    ...
    @Override
    public Article convertPostDTOToEntity(ArticlePostDTO postDTO) {
        if ( postDTO == null ) {
            return null;
        }
        ...
        article.setAnalytics( articleAnalyticsPostDTOToArticleAnalytics( postDTO.getAnalytics() ) );
        article.setOwner( ownerPostDTOToOwner( postDTO.getOwner() ) );
        article.setNewspaper( newspaperPostDTOToNewspaper( postDTO.getNewspaper() ) );
        article.setAuthor( authorPostDTOToAuthor( postDTO.getAuthor() ) );
        article.setName( postDTO.getName() );
        article.setPublisher( publisherPostDTOToPublisher( postDTO.getPublisher() ) );
        article.setTopic( topicPostDTOToTopic( postDTO.getTopic() ) );
    ...
    @Override
    public Article updateEntityFromPutDTO(ArticlePutDTO putDTO, Article article) {
        if ( putDTO == null && article == null ) {
            return null;
        }
        ...
        if ( putDTO != null ) {
            article1.setAnalytics( articleAnalyticsPutDTOToArticleAnalytics( putDTO.getAnalytics() ) );
            article1.setOwner( ownerPutDTOToOwner( putDTO.getOwner() ) );
            article1.setNewspaper( newspaperPutDTOToNewspaper( putDTO.getNewspaper() ) );
            article1.setAuthor( authorPutDTOToAuthor( putDTO.getAuthor() ) );
            article1.setName( putDTO.getName() );
            article1.setPublisher( publisherPutDTOToPublisher( putDTO.getPublisher() ) );
            article1.setTopic( topicPutDTOToTopic( putDTO.getTopic() ) );
            article1.setContent( putDTO.getContent() );
        }
